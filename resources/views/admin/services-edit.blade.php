						...
						<div class="row">
							<div class="col-xl-12">
							  	<div class="box">
									...
									<!-- /.box-header -->
									<div class="box-body">
									<form action="{{url('services-update',$ser->id)}}" method="post" enctype="multipart/form-data">
											@csrf
											<div class="row">
												<div class="col-md-6 mt-3">
													<label for="">Title</label>
													<input value="{{$ser->title}}" type="text" name="title" class="form-control" placeholder="title">
												@error('title')
												...
												<div class="col-md-6 mt-3">
													...
													<input value="{{$ser->shortdescription}}" type="text" name="short" class="form-control" placeholder="short description">
												@error('short')
													<div class="error">{{ $message }}</div>
												@enderror
												</div>
												<div class="col-md-6 mt-3">
													...
													<input value="{{$ser->description}}" type="text" name="description" class="form-control" placeholder="Description">
												@error('description')
													<div class="error">{{ $message }}</div>
												@enderror
												</div>
												<div class="col-md-6 mt-3">
													...
													<input type="hidden" name="thu" value="{{$ser->thumbnail}}">
												...
												<div class="col-md-6 mt-3">
													...
													<input type="hidden" name="im" value="{{$ser->img}}">
												...
												<div class="col-md-6 mt-3">
													...
													<input value="{{$ser->url}}" type="text" name="urls" class="form-control" placeholder="url" id="inputBox" class="hidden">
												@error('url')
													<div class="error">{{ $message }}</div>
												@enderror
												</div>
